...
void ButtonDriver_setItsMicrowaveEmitter(ButtonDriver *const me, MicrowaveEmitter *
    p_MicrowaveEmitter)
{
...
static void cleanUpRelations(ButtonDriver *const me)
{
  ...
  {
    ButtonDriver *p_ButtonDriver = Button_getItsButtonDriver(me->itsButton);
